...
def create_authentication_attempt_table():
    execute_query("""
        CREATE TABLE IF NOT EXISTS AuthenticationAttempt (
            ...
            FOREIGN KEY (AccessSessionID) REFERENCES AccessSession(AccessSessionID),
            FOREIGN KEY (EmployeeID) REFERENCES Employee(EmployeeID)
        )
    """)
...
def create_security_event_table():
    execute_query("""
        CREATE TABLE IF NOT EXISTS SecurityEvent (
            ...
            FOREIGN KEY (AccessSessionID) REFERENCES AccessSession(AccessSessionID),
            FOREIGN KEY (EmployeeID) REFERENCES Employee(EmployeeID),
            FOREIGN KEY (ResolvedByAdminUserID) REFERENCES AdminUser(AdminUserID)
        )
    """)
...
def create_database():
    ...
    print("[DATABASE] Mantrap database created successfully")
